...
public class PhotographerController {
    ...
    @PostMapping("/add")
    public @ResponseBody ResponseEntity<Photographer> savePhotographer(@RequestBody Photographer photographer){
        try {
    ...
    @GetMapping("/get/{id}")
    public @ResponseBody ResponseEntity<Photographer> getPhotographer(@PathVariable Long id){
        try {
            return new ResponseEntity<>(
                    photographerService.findPhotographer(id),
                    HttpStatus.OK
            );
        }catch (Exception e){
            return new ResponseEntity<>(
    ...
    @GetMapping("/get-all")
    public @ResponseBody ResponseEntity<List<Photographer>> getPhotographers(){
        try {
            return new ResponseEntity<>(
                    photographerService.findPhotographers(),
                    HttpStatus.OK
            );
        }catch (Exception e){
            return new ResponseEntity<>(
